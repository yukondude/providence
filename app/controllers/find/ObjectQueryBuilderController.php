<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/ObjectQueryBuilderController.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 * ----------------------------------------------------------------------
 */
 	require_once(__CA_LIB_DIR__."/ca/BaseQueryBuilderController.php");
	...
	require_once(__CA_MODELS_DIR__."/ca_sets.php");
 	...
 	class ObjectQueryBuilderController extends BaseQueryBuilderController {
 		# -------------------------------------------------------
 		/**
 		 ...
 		 */
 		protected $ops_find_type = 'query_builder';
